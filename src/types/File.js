export class File {
    ...
    file_name;
    content_nav;
    constructor(id, content, css, user_name, directory, file_name, content_nav) {
        this.id = id;
...
export async function get_file(apiUrl, id) {
...
export async function add_file(apiUrl, user_name, directory, file_name) {
...
export async function update_content(apiUrl, id, content) {
    try {

import { AccessibilityHelp, SimpleUploadAdapter, PasteFromOffice, Autoformat, Autosave, BalloonToolbar, BlockQuote, Bold, Essentials, FullPage, GeneralHtmlSupport, Heading, HtmlComment, HtmlEmbed, Indent, IndentBlock, Italic, Link, Paragraph, SelectAll, ShowBlocks, SourceEditing, Table, TableCaption, TableCellProperties, TableColumnResize, TableProperties, TableToolbar, TextTransformation, Underline, Undo, Image, ImageInsert, ImageBlock, ImageInline, ImageInsertViaUrl, ImageResize, ImageStyle, ImageToolbar, ImageUpload, FontBackgroundColor, FontColor, FontFamily, FontSize, Clipboard, PastePlainText, } from 'ckeditor5';
// @ts-ignore
